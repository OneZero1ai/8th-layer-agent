    ...
    return (
      <div className="flex h-full items-center justify-center bg-[#06061a] p-12">
        <div className="max-w-md text-center">
          <Monitor
            className="mx-auto h-10 w-10 text-[#7C5CFF]"
            strokeWidth={1.4}
          />
          <h2
          ...
          >
            The Network Operations Center is dense — it needs at least{" "}
            {minWidth}px of width. Switch to a desktop browser to see the full
            topology.
          </p>
          <div
